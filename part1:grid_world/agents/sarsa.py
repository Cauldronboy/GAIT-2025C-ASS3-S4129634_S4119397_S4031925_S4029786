...
- Epsilon-greedy exploration matching Q-learning
- More conservative behavior around hazards
"""
...
class SARSATable:
    """Q-table for storing state-action values (same structure as Q-learning)."""
...
class SARSAAgent:
    ...
    def update(self, state: Tuple, action: int, reward: float, 
        ...
        This makes SARSA learn from the actual action taken (on-policy).
        ...
        Args:
            ...
            next_action: Next action that will be taken
        ...
        if done:
            ...
            # Use Q-value of the next action that will actually be taken
